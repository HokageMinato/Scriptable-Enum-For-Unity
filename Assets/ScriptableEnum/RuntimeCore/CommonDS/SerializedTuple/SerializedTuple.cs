...
namespace ScriptableEnumSystem.CommonDS
{
    ...
    //TODO Add proper setters to each.
    // TODO Check if adding indexers insteadof property is productive ?
    public class SerializedTuple<T> 
    {
        #region PUBLIC_VARS
        public T v1;
        public static string NameMapFieldName
        {
            get
            {
                return nameof(nameMap);
            }
        }
        #endregion
        ...
        [UnityEngine.HideInInspector][UnityEngine.SerializeField] public string[] nameMap;
        #endregion
